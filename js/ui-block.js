...
var uiBlock = function () {
    ...
    function insert(dic) {
        ...
        function header(selector) {
            ...
            i18n.run($(selector)
                .addClass("container header hidden")
                .html(
                    "<div>" +
        ...
        function selectWalletFile(selector, callback) {
            ...
            i18n.run($(selector)
                ...
                .html(
                    '<label class="file empty btn btn-lg btn-outline-secondary"><span>选择钱包 Select Wallet</span><input type=file></label>' +
